...
class UNet(nn.Module):
    ...
    def __init__(self, in_shape, n_classes=2):
        ...
        self.down_1 = StackEncoder(channels, 64, kernel_size=3) # 1024
        self.down_2 = StackEncoder(64, 128, kernel_size=3)      # 512
        self.down_3 = StackEncoder(128, 256, kernel_size=3)     # 256
        self.down_4 = StackEncoder(256, 512, kernel_size=3)     # 128
        self.down_5 = StackEncoder(512, 1024, kernel_size=3)    # 64

        # BOTTLENECK
        self.bottleneck = Bridge(1024, 1024)

        # DECODER PART
        self.up_5 = StackDecoder(512, 1024, 512, kernel_size=3)      # 128
        self.up_4 = StackDecoder(256, 512, 256, kernel_size=3)       # 256
        self.up_3 = StackDecoder(128, 256, 128, kernel_size=3)       # 512
        self.up_2 = StackDecoder(64, 128, 64, kernel_size=3)         # 1024
        self.up_1 = StackDecoder(32, 64, 32, kernel_size=3)          # 2048
